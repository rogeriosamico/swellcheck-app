...
const Slider = React.forwardRef(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    <SliderPrimitive.Thumb
      className="relative block h-6 w-6 rounded-full border-2 border-[var(--surface-secondary)] bg-[var(--surface-secondary)] ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 before:absolute before:-inset-[10px] before:content-['']" />
  </SliderPrimitive.Root>
))
